...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(distributionName, version, build, location) => "${distributionName} ${version} (${build}) at ${location}";

  static m5(shell) => "Your shell at ${shell} isn\'t officially supported, do you want to generate the script anyways?";

  static m6(version, distribution) => "Version ${version} is not supported by distribution ${distribution}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "downloadingJava" : MessageLookupByLibrary.simpleMessage("Downloading Java"),
    "helpFlagHelp" : MessageLookupByLibrary.simpleMessage("Prints this help message"),
    "javaInstallation" : m1,
    "jvmPathOptionDescription" : MessageLookupByLibrary.simpleMessage("Path to the Java installation to use"),
    "jvmVersionOptionDescription" : MessageLookupByLibrary.simpleMessage("Java version to install"),
    ...
    "serverOptionDescription" : MessageLookupByLibrary.simpleMessage("The path to the server to delete"),
    "shellCompletionsOnWindows" : MessageLookupByLibrary.simpleMessage("Shell completion isn\'t supported on Windows, do you want to generate the script anyways?"),
    "shellNotSupported" : m5,
    "updateCommand" : MessageLookupByLibrary.simpleMessage("Update an existing Server"),
    "updateCommandIndev" : MessageLookupByLibrary.simpleMessage("This feature is currently in development"),
    ...
    "versionFlagDescriptionNew" : MessageLookupByLibrary.simpleMessage("The MC version to install"),
    "versionFlagDescriptionUpdate" : MessageLookupByLibrary.simpleMessage("The MC version to upgrade to"),
    "versionNotSupported" : m6,
    "yesFlagDescription" : MessageLookupByLibrary.simpleMessage("Answers all yes/no prompts with yes")
  };
}
